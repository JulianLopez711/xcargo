    ...
    async def _extraer_con_openai(self, contents: bytes) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt = """
                    ...
                    → AUTOMÁTICAMENTE tipo_comprobante = "nequi"
                    ✅ También detectar: colores rosados/magentas, códigos QR, menciones explícitas de "Nequi"

                    REGLA 2 - TRANSFERENCIA (ALTA PRIORIDAD):  
                    ✅ Si encuentras una referencia que EMPIEZA con varios ceros consecutivos (ejemplo: 000009200, 0000012345)
                    → AUTOMÁTICAMENTE tipo_comprobante = "transferencia"
                    ✅ También detectar: PSE, CUS, CUD, apps bancarias digitales

                    REGLA 3 - CONSIGNACION (ALTA PRIORIDAD):
                    ✅ Si detectas texto "Redeban" o "CORRESPONSAL BANCOLOMBIA" 
                    ✅ Si es un recibo físico en papel térmico (blanco con texto negro monocromático)
                    ✅ Si encuentras "APRO:" o "APROB:" seguido de números
